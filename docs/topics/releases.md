...
> The K2 mode is in Beta from 2024.2. The performance and stability of code highlighting and code completion have
> been significantly improved, but not all IDE features are supported yet.
>
{type="warning"}
